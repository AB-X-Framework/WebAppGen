...
class PageContent {
    ...
    static renderImg(output, js, specs) {
        var results =
    ...
    static renderDiv(output, js, specs) {
        var results =
            `<div id="${specs.id}"  ></div>`
        output.push(results);
    }

    static renderDivider(output, js, specs) {
        var results =
    ...
    static renderTextarea(output, js, specs) {
        let content;
        if (typeof specs.content === "undefined") {
            content = "";
        } else {
    ...
    static renderHeader(output, js, specs) {
        var links = "";
    ...
    static renderFooter(output, js, specs) {
        output.push(`
        <footer  id="${innerSpecs.id}" class="page-footer ${PageContent.global.themeBase}">
          <div class="container">
            <div class="row">
